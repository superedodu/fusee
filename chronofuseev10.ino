...
void loop() {
  ...
  buttonState = 0 ;
  //DEBUG
  Serial.print ("Menu ");Serial.print (menu); Serial.print (" Bouton : ") ; Serial.print(buttonState); Serial.print (" MenuChange : "); Serial.print (menuChange); Serial.print ("menu select : "); Serial.print (menuSelect);
...
case 2 :                                                                                           // VENUS
  ...
  lcd.print ("     Venus ?    ");
    Serial.print ("menu venus"); Serial.print (" Etape : "); Serial.println (varEtape);;
   buttonState = analogRead (PinButton);
...
if (timerS < 1 && timerM ==0)                          // Un son se déclenche à la fin du chrono
{
  tone (PinSon, 880);
delay (300);
noTone (PinSon);
